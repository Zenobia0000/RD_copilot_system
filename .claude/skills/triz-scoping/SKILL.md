...
本 skill 實作 Auto-TRIZ 閉環流程的 Step 0（流程定位見 `docs/_domain-knowledge/DK-01--auto-triz-process.md` §3；製造領域邊界見 `docs/_domain-knowledge/DK-05--domain-fundamentals.md` §5.1）。
