...
**最後更新**：`2026-04-28`
**狀態**：`Skeleton`
**模板來源**：`VibeCoding_Workflow_Templates/15_documentation_and_maintenance_guide.md`
...
| **Domain Knowledge** | DK-01-05 方法論 | `docs/_domain-knowledge/` | All（培訓） |
| **TRIZ Strategy** | 策略 SSOT、UML、engineering 範本 | `docs/_harness/` | TL / TRIZ-SME / RD |
...
| **Design System** | Atomic Design 規格 | `rd_assistant_design_system/design-system-specs/` | Design / FE |
...
| 方法論知識庫 | 人 | Skill（參考） | `docs/_domain-knowledge/` |
...
- 收進 `docs/_domain-knowledge/postmortems/`
- Quarterly review
...
- 模板：`VibeCoding_Workflow_Templates/15_documentation_and_maintenance_guide.md`
