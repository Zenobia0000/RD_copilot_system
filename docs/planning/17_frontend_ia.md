...
| `phase3-converge` | 4 | P10 CadInProgress, P11 DesignReview (G5 `[DEFER → Beta]`), P12 DecisionRecord (G6 `[DEFER → Beta]`), P13 Feynman (G7 `[DEFER → GA]`) |
...
Phase II — Diverge                     ▼
   P07 Track (X1 [COVERED]) → P08 Create (X2 [COVERED]) → P09 PreCAD (Gate P [SIMPLIFIED]) ─┐
                                                                                              │ Phase Gate X
Phase III — Converge                                                                          ▼
   P10 CadInProgress → P11 Review (G5 [DEFER]) → P12 Decide (G6 [DEFER]) → P13 Feynman (G7 [DEFER])
```
